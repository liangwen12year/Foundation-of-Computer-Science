import argparse
import json
parser = argparse.ArgumentParser(description="This is about 'HW2 1.6c' simple DFA implementation. The DFA definition is specified via .dfa file; input string is read from stdin. In non-verbose mode,print Accept or Not ACCEPT as the case may be",epilog="*******use the command: python3 dfa2.py -d m2.dfa -v*******alpabet is {0,1} ") 
